							...
							<div class="card">
								<div class="card-body">
									...
									<div class="card mb-12">
										<div
											class="card-body d-flex justify-content-between card-rounded p-0 d-flex bg-info">
											<div class="d-flex flex-column flex-lg-row-auto p-10 p-md-20">
												<h1 class="fw-bolder text-white">DATA AKUN KHUSUS</h1>
									...
									<div class="mb-10">
										...
										<div class="d-flex justify-content-end align-items-center mb-7">
											<a href="<?= base_url('khusus/tambah_akun') ?>"
												class="btn btn-light-primary btn-sm fw-bolder">Tambah Akun Khusus</a>
										</div>
										<!--end::Heading-->
										<!--begin::Products-->
										<div class="row g-5 g-xxl-8">
											...
											<!--begin::Product-->
                                            <?php foreach ($user_khusus as $data) :?>
													...
													<div class="card-body p-0">
														...
														<div class="overlay rounded overflow-hidden">
															<div class="overlay-wrapper rounded bg-light text-center">
																<img src="<?= base_url() ?>uploadfoto/<?= $data->foto?>" alt=""
																	class="mw-80 w-150px" style="height:150px"/>
															</div>
															<div class="overlay-layer">
																<a href="aplication/opd.html"
														...
														<div
															...
															<a href="<?= base_url ('khusus')?>"
																class="fs-4 fw-bolder text-gray-800 text-hover-primary mb-1"><?= $data->nama ?></a>
