        ...
        var i = {
            ...
            S = function (e) {
                if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.accordion.show", e)) {
                    !1 === n.options.accordion.expand && x(e);
                    var t = g(e);
...
var KTLayoutSidebar = function () {
    var e = function (e, t, n, i) {
        var r = document.querySelector(t),
            o = parseInt(KTUtil.css(r, "height"));
        if (r) {
            var a = new ApexCharts(r, {
                series: [{
                    name: "Profit",
                    data: n
                }],
            ...
            !0 === i && (a.render(), l = !0), s.addEventListener("shown.bs.tab", (function (e) {
                0 == l && (a.render(), l = !0)
            }))
        }
    };
    return {
        init: function () {
            ...
            t = document.querySelector("#kt_user_chart"), n = parseInt(KTUtil.css(t, "height")), t && new ApexCharts(t, {
                ...
                labels: ["Progress"]
            }).render(), e("#kt_sidebar_tab_1", "#kt_sidebar_tab_1_chart", [40, 30, 25, 40, 50, 30], !0), e("#kt_sidebar_tab_2", "#kt_sidebar_tab_2_chart", [30, 30, 25, 45, 30, 40], !1), e("#kt_sidebar_tab_3", "#kt_sidebar_tab_3_chart", [25, 30, 40, 30, 35, 30], !1), e("#kt_sidebar_tab_4", "#kt_sidebar_tab_4_chart", [25, 30, 35, 40, 50, 30], !1), e("#kt_sidebar_tab_5", "#kt_sidebar_tab_5_chart", [40, 20, 50, 50, 55, 45], !1), e("#kt_sidebar_tab_6", "#kt_sidebar_tab_6_chart", [40, 20, 50, 50, 55, 45], !1)
        }
    }
}();
KTUtil.onDOMContentLoaded((function () {
